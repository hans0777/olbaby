...
오엘베이비 고객관리 시스템은 촬영 예약부터 사후 관리까지 **6단계 고객 여정**을 완전 자동화하여, 고객 만족도 향상과 재방문율 증대를 실현하는 올인원 CRM 솔루션입니다.

### ✨ 핵심 기능

- 📊 **실시간 대시보드**: 고객/예약/설문 현황 한눈에 확인
- 👥 **고객 DB 관리**: 고객 정보, 아기 정보, 상담 이력 통합 관리
- 📅 **예약 현황 관리**: 예약 상태별 필터링 및 촬영 일정 관리
- 💬 **자동 문자 발송**: D-1 안내, 당일 혜택, 설문 요청 자동화
- 📝 **만족도 조사**: 실시간 설문 수집 및 분석
- 🎁 **이벤트 관리**: 쿠폰, 할인 혜택 자동 지급

### 🎯 6단계 고객 여정 자동화

```
상담 접수 → 예약 확정 → D-1 안내 → 촬영 당일 → 촬영 후 → 사후 관리
   ↓          ↓           ↓          ↓          ↓         ↓
고객등록   확정문자    안내페이지   혜택페이지   설문조사   쿠폰발송
```
